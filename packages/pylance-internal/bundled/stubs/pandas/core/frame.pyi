...
class _iLocIndexerFrame(_iLocIndexer):
    @overload
    def __getitem__(self, idx: Tuple[int, int]) -> Scalar: ...  # Get a single cell      
    @overload
    def __getitem__(self, idx: Union[int, Tuple[int, IndexType], Tuple[IndexType, IndexType], Tuple[Union[int, IndexType], Union[int, str]]]) -> NDFrame: ...
...
class _LocIndexerFrame(_LocIndexer):
    ...
    @overload
    def __getitem__(self, idx: Union[int, StrLike, IndexType, MaskType, Tuple[Union[int, StrLike, IndexType, MaskType], Union[int, StrLike, IndexType, MaskType]]],) -> NDFrame: ...    
