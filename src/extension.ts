...
*
* Provides client for PyRx language server. This portion runs
...
import { ProgressReporting } from '../pyright/client/src/progress';
import { commandCreateTypeStub } from '../pyright/common/commands';
...
export function activate(context: ExtensionContext) {
	...
	const clientOptions: LanguageClientOptions = {
		...
		synchronize: {
			...
			configurationSection: ['python', 'pyrx']
		}
	}
	...
	const textEditorCommands = ['pyrx.organizeimports', 'pyrx.addoptionalforparam'];
	...
	const genericCommands = [commandCreateTypeStub];
