import { TestCancellationToken, FourSlashTestType, Marker, Range, FourSlashFile, FourSlashData } from "./fourSlashTypes";
import { forEach } from "../../../common/collectionUtils";
...
export class TestState {
    ...
    private inputFiles = new Map<string, string>();
