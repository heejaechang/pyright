...
class Series(Generic[_DType]):
    ...
    def add(self, other: Union[Series[_DType], _Scalar], level: Optional[_LevelType] = ..., fill_value: Optional[float] = ..., axis: Literal[0] = ...) -> Series[_DType]: ...
    def add_prefix(self, prefix: _str) -> Series[_DType]: ...
    def add_suffix(self, suffix: _str) -> Series[_DType]: ...
    def aggregate(self, func: Union[Callable, _str, List[Union[Callable, _str]], Dict[_SeriesAxisType, Union[Callable, _str]]], axis: _SeriesAxisType = ..., *args, **kwargs) -> None:
...
'''
        pass
    def agg(self, func: Union[Callable, _str, List[Union[Callable, _str]], Dict[_SeriesAxisType, Union[Callable, _str]]], axis: _SeriesAxisType = ..., *args, **kwargs) -> None: ...
    def align(self, other: Union[DataFrame, Series[Any]], join: Literal['inner', 'outer', 'left', 'right'] = ..., axis: Optional[_AxisType] = ..., level: Optional[_LevelType] = ..., copy: _bool = ..., fill_value: Optional[Any] = ..., method: Optional[Literal['backfill', 'bfill', 'pad', 'ffill']] = ..., limit: Optional[int] = ..., fill_axis: _SeriesAxisType = ..., broadcast_axis: Optional[_SeriesAxisType] = ...) -> Tuple[Series, Series]:
...
'''
        pass
    def all(self, axis: _SeriesAxisType = ..., bool_only: Optional[_bool] = ..., skipna : _bool = ..., level: Optional[_LevelType] = ..., **kwargs) -> _bool: ...
    def any(self, axis: _SeriesAxisType = ..., bool_only: Optional[_bool] = ..., skipna : _bool = ..., level: Optional[_LevelType] = ..., **kwargs) -> _bool: ...
    def append(self, to_append: Union[Series[Any], Sequence[Series[Any]]], ignore_index: _bool = ..., verify_integrity: _bool = ...) -> Series[_DType]: ...
    def apply(self, func: Callable, convert_dtype: _bool = ..., args: Tuple = ..., **kwds) -> Union[Series[Any], DataFrame]: ...
    ...
    def argsort(self, axis: _SeriesAxisType = ..., kind: Literal['mergesort', 'quicksort', 'heapsort'] = ..., order: None = ...) -> Series[int]: ...
    ...
    def asof(self, where: Union[_Scalar, Sequence[_Scalar]], subset: Optional[Union[_str, Sequence[_str]]] = ...) -> Union[_Scalar, Series[_DType]]: ...
    def astype(self, dtype: Union[Type[_str], Type[int], Type[float]], copy: _bool = ..., errors: Literal['raise', 'ignore'] = ...) -> Series: ...
    def at_time(self, time: Union[_str, datetime.time], asof: _bool = ..., axis: Optional[_SeriesAxisType] = ...) -> Series[_DType]: ...
    ...
    def between_time(self, start_time: Union[_str, datetime.time], end_time: Union[_str, datetime.time], include_start: _bool = ..., include_end: _bool = ..., axis: Optional[_SeriesAxisType] = ...) -> Series[_DType]: ...
    @overload
    def bfill(self, value: Union[_DType, Dict, Series[_DType], DataFrame], axis: _SeriesAxisType = ..., limit: Optional[int] = ..., downcast: Optional[Dict] = ..., *, inplace: Literal[True]) -> Series[_DType]: ...
    @overload
    def bfill(self, value: Union[_DType, Dict, Series[_DType], DataFrame], axis: _SeriesAxisType = ..., inplace: Literal[False] = ..., limit: Optional[int] = ..., downcast: Optional[Dict] = ...) -> None: ...
    def bool(self) -> _bool: ...
    def clip(self, lower: Optional[float] = ..., upper: Optional[float] = ..., axis: Optional[_SeriesAxisType] = ..., inplace: _bool = ..., *args, **kwargs) -> Series[_DType]: ...
    ...
    def cummax(self, axis: Optional[_SeriesAxisType] = ..., skipna: _bool = ..., *args, **kwargs) -> Series[_DType]: ...
    def cummin(self, axis: Optional[_SeriesAxisType] = ..., skipna: _bool = ..., *args, **kwargs) -> Series[_DType]: ...
    def cumprod(self, axis: Optional[_SeriesAxisType] = ..., skipna: _bool = ..., *args, **kwargs) -> Series[_DType]: ...
    def cumsum(self, axis: Optional[_SeriesAxisType] = ..., skipna: _bool = ..., *args, **kwargs) -> Series[_DType]: ...
    ...
    def div(self, other: Union[num, _ListLike, Series[_DType]], level: Optional[_LevelType] = ..., fill_value: Optional[float] = ..., axis: _SeriesAxisType = ...) -> Series[float]: ...
    def divide(self, other: Union[num, _ListLike, Series[_DType]], level: Optional[_LevelType] = ..., fill_value: Optional[float] = ..., axis: _SeriesAxisType = ...) -> Series[float]: ...
    def divmod(self, other:  Union[num, _ListLike, Series[_DType]], level: Optional[_LevelType] = ..., fill_value: Optional[float] = ..., axis: _SeriesAxisType = ...) -> Series[_DType]: ...
    @overload
    def dot(self, other: Union[DataFrame, Series[_DType]]) -> Series[_DType]: ...
    @overload
    def dot(self, other: _ListLike) -> _np.ndarray: ...
    def drop(self, labels: Optional[Union[_str, List]] = ..., axis: _SeriesAxisType = ..., index: Optional[Union[List[_str], List[int], Index]] = ..., columns: Optional[Union[_str, List]] = ..., level: Optional[_LevelType] = ..., inplace: _bool = ..., errors: Literal['ignore', 'raise'] = ...) -> Series: ...
    ...
    def dropna(self, axis: _SeriesAxisType = ..., inplace: _bool = ..., how: Optional[_str] = ...) -> Series[_DType]: ...
    def duplicated(self, keep: Literal['first', 'last', False] = ...) -> Series[_bool]: ...
    def eq(self, other: Union[_Scalar, Series[_DType]], level: Optional[_LevelType] = ..., fill_value: Optional[float] = ..., axis: _SeriesAxisType = ...) -> Series[_bool]: ...
    def equals(self, other: Series[_DType]) -> _bool: ...
    def ewm(self, com: Optional[float] = ..., span: Optional[float] = ..., halflife: Optional[float] = ..., alpha: Optional[float] = ..., min_periods: int = ..., adjust: _bool = ..., ignore_na: _bool = ..., axis: _SeriesAxisType = ...) -> DataFrame: ...
    ...
    @overload
    def ffill(self, value: Union[_DType, Dict, Series[_DType], DataFrame], axis: _SeriesAxisType, inplace: Literal[True], limit: Optional[int] = ..., downcast: Optional[Dict] = ...) -> Series[_DType]: ...
    @overload
    ...
    @overload
    def ffill(self, value: Union[_DType, Dict, Series[_DType], DataFrame], axis: _SeriesAxisType = ..., inplace: Literal[False] = ..., limit: Optional[int] = ..., downcast: Optional[Dict] = ...) -> None: ...
    @overload
    def fillna(self, value: Union[_DType, Dict, Series[_DType], DataFrame], method: Optional[Literal['backfill', 'bfill', 'pad', 'ffill']] = ..., axis: _SeriesAxisType = ..., limit: Optional[int] = ..., downcast: Optional[Dict] = ..., *, inplace: Literal[True]) -> Series[_DType]:
...
'''
        pass
    @overload
    def fillna(self, value: Union[_DType, Dict, Series[_DType], DataFrame],method: Optional[Literal['backfill', 'bfill', 'pad', 'ffill']] = ..., axis: _SeriesAxisType = ...,  inplace: Literal[False] = ..., limit: Optional[int] = ..., downcast: Optional[Dict] = ...) -> None: ...
    def filter(self, items: Optional[_ListLike] = ..., like: Optional[_str] = ..., regex: Optional[_str] = ..., axis: Optional[_SeriesAxisType] = ...) -> Series[_DType]: ...
    def first(self, offset: Any) -> Series[_DType]: ...
    def first_valid_index(self) -> _Scalar: ...
    def floordiv(self, other: Union[num, _ListLike, Series[_DType]], level: Optional[_LevelType] = ..., fill_value: Optional[float] = ..., axis: Optional[_SeriesAxisType] = ...) -> Series[int]: ...
    def ge(self, other: Union[_Scalar, Series[_DType]], level: Optional[_LevelType] = ..., fill_value: Optional[float] = ..., axis: _SeriesAxisType = ...) -> Series[_bool]: ...
    def get(self, key: object, default: Optional[_DType] = ...) -> _DType: ...
    def groupby(self, by: Optional[Any] = ..., axis: _SeriesAxisType = ..., level: Optional[_LevelType] = ..., as_index: _bool = ..., sort: _bool = ..., group_keys: _bool = ..., squeeze: _bool = ..., observed: _bool = ...) -> SeriesGroupBy:
...
'''
        pass
    def gt(self, other: Union[_Scalar, Series[_DType]], level: Optional[_LevelType] = ..., fill_value: Optional[float] = ..., axis: _SeriesAxisType = ...) -> Series[_bool]: ...
    ...
    def interpolate(self, method: Literal['linear', 'time', 'index', 'values', 'pad', 'nearest', 'slinear', 'quadratic', 'cubic', 'spline', 'barycentric', 'polynomial', 'krogh', 'pecewise_polynomial', 'spline', 'pchip', 'akima', 'from_derivatives'] = ..., axis: Optional[_SeriesAxisType] = ..., limit: Optional[int] = ..., inplace: _bool = ..., limit_direction: Optional[Literal['forward', 'backward', 'both']] = ..., limit_area: Optional[Literal['inside', 'outside']] = ..., downcast: Optional[Literal['infer']] = ..., **kwargs) -> Series[_DType]: ...
...
'''
    ...
    def keys(self) -> List: ...
    @overload
    def kurt(self, axis: Optional[_SeriesAxisType] = ..., skipna: _bool = ..., numeric_only: Optional[_bool] = ..., *, level: _LevelType, **kwargs) -> Series[_DType]: ...
    @overload
    def kurt(self, axis: Optional[_SeriesAxisType] = ..., skipna: _bool = ..., level: None = ..., numeric_only: Optional[_bool] = ..., **kwargs) -> _Scalar: ...
    @overload
    def kurtosis(self, axis: Optional[_SeriesAxisType] = ..., skipna: _bool = ..., numeric_only: Optional[_bool] = ..., *, level: Optional[_LevelType], **kwargs) -> Series[_DType]: ...
    @overload
    def kurtosis(self, axis: Optional[_SeriesAxisType] = ..., skipna: _bool = ..., level: None = ..., numeric_only: Optional[_bool] = ..., **kwargs) -> _Scalar: ...
    def last(self, offset: Any) -> Series[_DType]: ...
    def last_valid_index(self) -> _Scalar: ...
    def le(self, other: Union[_Scalar, Series[_DType]], level: Optional[_LevelType] = ..., fill_value: Optional[float] = ..., axis: _SeriesAxisType = ...) -> Series[_bool]: ...
    def lt(self, other: Union[_Scalar, Series[_DType]], level: Optional[_LevelType] = ..., fill_value: Optional[float] = ..., axis: _SeriesAxisType = ...) -> Series[_bool]: ...
    @overload
    def mad(self, axis: Optional[_SeriesAxisType] = ..., skipna: _bool = ..., *, level: Optional[_LevelType], **kwargs) -> Series[_DType]: ...
    @overload
    def mad(self, axis: Optional[_SeriesAxisType] = ..., skipna: _bool = ..., level: None = ...,  **kwargs) -> _Scalar: ...
    def map(self, arg: Any, na_action: Optional[Literal['ignore']] = ...) -> Series[_DType]: ...
    def mask(self, cond: Union[Series[_DType], _np.ndarray, Callable], other: Union[_Scalar, Series[_DType], DataFrame, Callable] = ..., inplace: _bool = ..., axis: Optional[_SeriesAxisType] = ..., level: Optional[_LevelType] = ..., errors: Literal['raise', 'ignore'] = ..., try_cast: _bool = ...) -> Series[_DType]: ...
    @overload
    def max(self, axis: Optional[_SeriesAxisType] = ..., skipna: _bool = ..., numeric_only: Optional[_bool] = ..., *, level: _LevelType, **kwargs) -> Series[_DType]: ...
    @overload
    def max(self, axis: Optional[_SeriesAxisType] = ..., skipna: _bool = ..., level: None = ..., numeric_only: Optional[_bool] = ..., **kwargs) -> _DType: ...
    @overload
    def mean(self, axis: Optional[_SeriesAxisType] = ..., skipna: _bool = ..., numeric_only: Optional[_bool] = ..., *, level: _LevelType, **kwargs) -> Series[_DType]: ...
    @overload
    def mean(self, axis: Optional[_SeriesAxisType] = ..., skipna: _bool = ..., level: None = ..., numeric_only: Optional[_bool] = ..., **kwargs) -> _DType: ...
    @overload
    def median(self, axis: Optional[_SeriesAxisType] = ..., skipna: _bool = ..., numeric_only: Optional[_bool] = ..., *, level: _LevelType, **kwargs) -> Series[_DType]: ...
    @overload
    def median(self, axis: Optional[_SeriesAxisType] = ..., skipna: _bool = ..., level: None = ..., numeric_only: Optional[_bool] = ..., **kwargs) -> _DType: ...
    def memory_usage(self, index: _bool = ..., deep: _bool = ...) -> int: ...
    @overload
    def min(self, axis: Optional[_SeriesAxisType] = ..., skipna: _bool = ..., numeric_only: Optional[_bool] = ..., *, level: _LevelType, **kwargs) -> Series[_DType]: ...
    @overload
    def min(self, axis: Optional[_SeriesAxisType] = ..., skipna: _bool = ..., level: None = ..., numeric_only: Optional[_bool] = ..., **kwargs) -> _DType: ...
    def mod(self, other: Union[num, _ListLike, Series[_DType]], level: Optional[_LevelType] = ..., fill_value: Optional[float] = ..., axis: Optional[_SeriesAxisType] = ...) -> Series[_DType]: ...
    def mode(self, dropna: Any) -> Series[_DType]: ...
    def mul(self, other: Union[num, _ListLike, Series[_DType]], level: Optional[_LevelType] = ..., fill_value: Optional[float] = ..., axis: Optional[_SeriesAxisType] = ...) -> Series[_DType]: ...
    def multiply(self, other: Union[num, _ListLike, Series[_DType]], level: Optional[_LevelType] = ..., fill_value: Optional[float] = ..., axis: Optional[_SeriesAxisType] = ...) -> Series[_DType]: ...
    def ne(self, other: Union[_Scalar, Series[_DType]], level: Optional[_LevelType] = ..., fill_value: Optional[float] = ..., axis: _SeriesAxisType = ...) -> Series[_bool]: ...
...
'''
    ...
    def pow(self, other: Union[num, _ListLike, Series[_DType]], level: Optional[_LevelType] = ..., fill_value: Optional[float] = ..., axis: Optional[_SeriesAxisType] = ...) -> Series[_DType]: ...
    @overload
    def prod(self, axis: Optional[_SeriesAxisType] = ..., skipna: Optional[_bool] = ..., numeric_only: Optional[_bool] = ..., min_count: int = ..., *, level: _LevelType, **kwargs) -> Series[_DType]: ...
    @overload
    def prod(self, axis: Optional[_SeriesAxisType] = ..., skipna: Optional[_bool] = ..., level: None = ..., numeric_only: Optional[_bool] = ..., min_count: int = ..., **kwargs) -> _Scalar: ...
    @overload
    def product(self, axis: Optional[_SeriesAxisType] = ..., skipna: Optional[_bool] = ..., numeric_only: Optional[_bool] = ..., min_count: int = ..., *, level: _LevelType, **kwargs) -> Series[_DType]: ...
    @overload
    def product(self, axis: Optional[_SeriesAxisType] = ..., skipna: Optional[_bool] = ..., level: None = ..., numeric_only: Optional[_bool] = ..., min_count: int = ..., **kwargs) -> _Scalar: ...
    @overload
    ...
    def radd(self, other: Union[Series[_DType], _Scalar], level: Optional[_LevelType] = ..., fill_value: Optional[float] = ..., axis: _SeriesAxisType = ...) -> Series[_DType]: ...
    def rank(self, axis: _SeriesAxisType = ..., method: Literal['average', 'min', 'max', 'first', 'dense'] = ..., numeric_only: Optional[_bool] = ..., na_option: Literal['keep', 'top', 'bottom'] = ..., ascending: _bool = ..., pct: _bool = ...) -> Series: ...
    def ravel(self, order: _str = ...) -> _np.ndarray: ...
    def rdiv(self, other: Union[Series[_DType], _Scalar], level: Optional[_LevelType] = ..., fill_value: Optional[float] = ..., axis: _SeriesAxisType = ...) -> Series[_DType]: ...
    def rdivmod(self, other: Union[Series[_DType], _Scalar], level: Optional[_LevelType] = ..., fill_value: Optional[float] = ..., axis: _SeriesAxisType = ...) -> Series[_DType]: ...
...
'''
    ...
    def rename(self, index: Optional[Any] = ..., *, axis: Optional[_SeriesAxisType] = ..., copy: _bool = ..., inplace: _bool = ..., level: Optional[_LevelType] = ..., errors: Literal['raise', 'ignore'] = ...) -> Series: ...
    @overload
    def rename_axis(self, mapper: Union[_Scalar, _ListLike] = ..., index: Optional[Union[_Scalar, _ListLike, Callable, Dict]] = ..., columns: Optional[Union[_Scalar, _ListLike, Callable, Dict]] = ..., axis: Optional[_SeriesAxisType] = ..., copy: _bool = ..., *, inplace: Literal[True]) -> None: ...
    @overload
    def rename_axis(self, mapper: Union[_Scalar, _ListLike]  = ..., index: Optional[Union[_Scalar, _ListLike, Callable, Dict]] = ..., columns: Optional[Union[_Scalar, _ListLike, Callable, Dict]] = ..., axis: Optional[_SeriesAxisType] = ..., copy: _bool = ..., inplace: Optional[Literal[False]] = ...) -> Series: ...
...
'''
    ...
    def resample(self, rule: Any, axis: _SeriesAxisType = ..., closed: Optional[_str] = ..., label: Optional[_str] = ..., convention: Literal['start', 'end', 's', 'e'] = ..., kind: Optional[Literal['timestamp', 'period']] = ..., loffset: Optional[Any] = ..., base: int = ..., on: Optional[str] = ..., level: Optional[_LevelType] = ...) -> Any: ...
    def reset_index(self, level: Optional[_LevelType] = ..., drop: _bool = ..., name: Optional[object] = ..., inplace: _bool = ...) -> Series[_DType]: ...
    def rfloordiv(self, other: Any, level: Optional[_LevelType] = ..., fill_value: Optional[Union[float, None]] = ..., axis: _SeriesAxisType = ...) -> Series[_DType]: ...
    def rmod(self, other: Union[Series[_DType], _Scalar], level: Optional[_LevelType] = ..., fill_value: Optional[float] = ..., axis: _SeriesAxisType = ...) -> Series[_DType]: ...
    def rmul(self, other: Union[Series[_DType], _Scalar], level: Optional[_LevelType] = ..., fill_value: Optional[float] = ..., axis: _SeriesAxisType = ...) -> Series[_DType]: ...
    # Next one should return a window class
    def rolling(self, window: Any, min_periods: Optional[int] = ..., center: _bool = ..., win_type: Optional[_str] = ..., on: Optional[_str] = ..., axis: _SeriesAxisType = ..., closed: Optional[_str] = ...) -> Any: ...
    def round(self, decimals: int = ..., *args, **kwargs) -> Series[_DType]: ...
    def rpow(self, other: Union[Series[_DType], _Scalar], level: Optional[_LevelType] = ..., fill_value: Optional[float] = ..., axis: _SeriesAxisType = ...) -> Series[_DType]: ...
    def rsub(self, other: Union[Series[_DType], _Scalar], level: Optional[_LevelType] = ..., fill_value: Optional[float] = ..., axis: _SeriesAxisType = ...) -> Series[_DType]: ...
    def rtruediv(self, other: Any, level: Optional[_LevelType] = ..., fill_value: Optional[Union[float, None]] = ..., axis: _SeriesAxisType = ...) -> Series[_DType]: ...
    def sample(self, n: Optional[int] = ..., frac: Optional[float] = ..., replace: _bool = ..., weights: Optional[Union[_str, _ListLike, _np.ndarray]] = ..., random_state: Optional[int] = ..., axis: Optional[_SeriesAxisType] = ...) -> Series[_DType]: ...
    @overload
...
'''
        pass
    @overload
    def sem(self, axis: Optional[_SeriesAxisType] = ..., skipna: Optional[_bool] = ..., ddof: int = ..., numeric_only: Optional[_bool] = ..., *, level: _LevelType, **kwargs) -> Series[_DType]: ...
    @overload
    def sem(self, axis: Optional[_SeriesAxisType] = ..., skipna: Optional[_bool] = ..., level: None = ..., ddof: int = ..., numeric_only: Optional[_bool] = ..., **kwargs) -> _Scalar: ...
    @overload
    def set_axis(self, labels: Union[Index, _ListLike], axis: _SeriesAxisType = ..., *, inplace: Literal[True]) -> None: ...
    @overload
    def set_axis(self, labels: Union[Index, _ListLike], axis: _SeriesAxisType = ..., inplace: Literal[False] = ...) -> Series[_DType]: ...
    def shift(self, periods: int = ..., freq: Optional[Any] = ..., axis: _SeriesAxisType = ..., fill_value: Optional[object] = ...) -> Series[_DType]:
...
'''
        pass
    @overload
    def skew(self, axis: Optional[_SeriesAxisType] = ..., skipna: Optional[_bool] = ..., numeric_only: Optional[_bool] = ..., *, level: _LevelType, **kwargs) -> Series[_DType]: ...
    @overload
    def skew(self, axis: Optional[_SeriesAxisType] = ..., skipna: Optional[_bool] = ..., level: None = ..., numeric_only: Optional[_bool] = ..., **kwargs) -> _Scalar: ...
    def slice_shift(self, periods: int = ..., axis: _SeriesAxisType = ...) -> Series[_DType]: ...
    def sort_index(self, axis: _SeriesAxisType = ..., level: Optional[_LevelType] = ..., ascending: _bool = ..., inplace: _bool = ..., kind: Literal['quicksort', 'heapsort', 'mergesort'] = ..., na_position: Literal['first', 'last'] = ..., sort_remaining: _bool = ..., ignore_index: _bool = ...) -> Series[_DType]: ...
    def sort_values(self, axis: _SeriesAxisType = ..., ascending: _bool = ..., inplace: _bool = ..., kind: Literal['quicksort', 'heapsort', 'mergesort'] = ..., na_position: Literal['first', 'last'] = ..., ignore_index: _bool = ...) -> Series[_DType]: ...
    def squeeze(self, axis: Optional[_SeriesAxisType] = ...) -> _Scalar: ...
    @overload
    def std(self, axis: Optional[_SeriesAxisType] = ..., skipna: Optional[_bool] = ..., ddof: int = ..., numeric_only: Optional[_bool] = ..., *, level: _LevelType, **kwargs) -> Series[float]: ...
    @overload
    def std(self, axis: Optional[_SeriesAxisType] = ..., skipna: Optional[_bool] = ..., level: None = ..., ddof: int = ..., numeric_only: Optional[_bool] = ..., **kwargs) -> float: ...
    def str(self) -> _str: ...
    def sub(self, other: Union[num, _ListLike, Series[_DType]], level: Optional[_LevelType] = ..., fill_value: Optional[float] = ..., axis: Optional[_SeriesAxisType] = ...) -> float: ...
    def subtract(self, other: Union[num, _ListLike, Series[_DType]], level: Optional[_LevelType] = ..., fill_value: Optional[float] = ..., axis: Optional[_SeriesAxisType] = ...) -> float: ...
    def sum(self, axis: Optional[_SeriesAxisType] = ..., skipna: Optional[_bool] = ..., level: Optional[_LevelType] = ..., numeric_only: Optional[_bool] = ..., min_count: int = ..., **kwargs) -> float: ...
...
'''
    ...
    def to_numpy(self, dtype: Optional[Type[_DTypeNp]] = ..., copy: _bool = ..., na_value: Any = ..., **kwargs) -> _np.ndarray: ...
    ...
    def transform(self, func: Union[List[Callable], Dict[_str, Callable]], axis: _SeriesAxisType = ..., *args, **kwargs) -> Series[_DType]:
...
'''
    ...
    def truediv(self, other: Any, level: Optional[_LevelType] = ..., fill_value: Optional[Union[float, None]] = ..., axis: _SeriesAxisType = ...) -> Series[float]: ...
    def truncate(self, before: Optional[Union[datetime.date, _str, int]] = ..., after: Optional[Union[datetime.date, _str, int]] = ..., axis: Optional[_SeriesAxisType] = ..., copy: _bool = ...) -> Series[_DType]: ...
    def tshift(self, periods: int = ..., freq: Any = ..., axis: _SeriesAxisType = ...) -> Series[_DType]: ...
    def tz_convert(self, tz: Any, axis: _SeriesAxisType = ..., level: Optional[_LevelType] = ..., copy: _bool = ...) -> Series[_DType]: ...
    def tz_localize(self, tz: Any, axis: _SeriesAxisType = ..., level: Optional[_LevelType] = ..., copy: _bool = ..., ambiguous: Any = ..., nonexistent: _str = ...) -> Series[_DType]: ...
    ...
    @overload
    def var(self, axis: Optional[_SeriesAxisType] = ..., skipna: Optional[_bool] = ..., ddof: int = ..., numeric_only: Optional[_bool] = ..., *, level: _LevelType, **kwargs) -> Series[_DType]: ...
    @overload
    def var(self, axis: Optional[_SeriesAxisType] = ..., skipna: Optional[_bool] = ..., level: None = ..., ddof: int = ..., numeric_only: Optional[_bool] = ..., **kwargs) -> _Scalar: ...
    def view(self, dtype: Optional[Any] = ...) -> Series[_DType]: ...
    def where(self, cond: Union[Series[_DType], Series[_DType], _np.ndarray], other: Any = ..., inplace: _bool = ..., axis: Optional[_SeriesAxisType] = ..., level: Optional[_LevelType] = ..., errors: _str = ..., try_cast: _bool = ...) -> Series[_DType]: ...
    def xs(self, key: Union[_str, Tuple[_str]], axis: _SeriesAxisType = ..., level: Optional[_LevelType] = ..., drop_level: _bool = ...) -> Series[_DType]: ...
...
class DataFrame:
    ...
    @overload
    def __getitem__(self, idx: Union[Series[_bool], DataFrame, List[_str], Index[_str], _np_ndarray_str],) -> DataFrame: ...
    def __iter__(self) -> Iterator: ...
    def __len__(self) -> int: ...
    def __setitem__(self, key: Any, value: Any) -> None: ...
...
'''
    ...
    def boxplot(self, column: Optional[Union[_str, List[_str]]] = ..., by: Optional[Union[_str, _ListLike]] = ..., ax: Optional[matplotlib.axes.Axes] = ..., fontsize: Optional[Union[float, _str]] = ..., rot: int = ..., grid: _bool = ..., figsize: Optional[Tuple[float, float]] = ..., layout: Optional[Tuple[int, int]] = ..., return_type: Optional[Literal['axes', 'dict', 'both']] = ..., backend: Optional[_str] = ..., **kwargs) -> Any: ...
    def clip(self, lower: Optional[float] = ..., upper: Optional[float] = ..., axis: Optional[_AxisType] = ..., inplace: _bool = ..., *args, **kwargs) -> DataFrame: ...
    ...
    @overload
    def dropna(self, axis: _AxisType = ..., how: Literal['any', 'all'] = ..., thresh: Optional[int] = ..., subset: Optional[List] = ..., inplace: Optional[Literal[False]] = ...) -> DataFrame: ...
...
'''
    ...
    def product(self, axis: Optional[_AxisType] = ..., skipna: _bool = ..., level: Optional[_LevelType] = ..., numeric_only: Optional[_bool] = ..., min_count: int = ..., **kwargs) -> DataFrame: ...
    @overload
...
'''
    ...
    def resample(self, rule: Any, axis: _AxisType = ..., closed: Optional[_str] = ..., label: Optional[_str] = ..., convention: Literal['start', 'end', 's', 'e'] = ..., kind: Optional[Literal['timestamp', 'period']] = ..., loffset: Optional[Any] = ..., base: int = ..., on: Optional[_str] = ..., level: Optional[_LevelType] = ...) -> Any: ...
    @overload
...
'''
    ...
    def unstack(self, level: _LevelType = ..., fill_value: Optional[Union[int, _str, Dict]] = ...) -> Union[DataFrame, Series[_DType]]: ...
...
'''
    ...
    def boxplot(self, grouped: DataFrame, subplots: bool = ..., column: Optional[Union[str, Sequence]] = ..., fontsize: Union[int, str] = ..., rot: float = ..., grid: bool = ..., ax: Optional[matplotlib.axes.Axes] = ..., figsize: Optional[Tuple[float, float]] = ..., layout: Optional[Tuple[int, int]] = ..., sharex: bool = ..., sharey: bool = ..., bins: Union[int, Sequence] = ..., backend: Optional[str] = ..., **kwargs) -> Union[matplotlib.AxesSubplot, List[matplotlib.AxesSubplot]]:
